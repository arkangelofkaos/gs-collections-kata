...
public class Exercise3Test extends CompanyDomainForKata {
    ...
    private static final Predicate<Customer> CUSTOMER_FROM_LONDON =
            x -> x.getCity().equalsIgnoreCase("London");
    ...
    public void howManyCustomersLiveInLondon() {
        int numberOfCustomerFromLondon = this.company.getCustomers()
    ...
    public void getLondonCustomers() {
        MutableList<Customer> customersFromLondon = this.company.getCustomers()
                .select(CUSTOMER_FROM_LONDON);
